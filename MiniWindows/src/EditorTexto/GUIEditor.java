...
public class GUIEditor {
    ...
    private JFileChooser createTxtFileChooser() {
        ...
        try {
            if (sistema != null && sistema.getSistemaArchivos() != null) {
                raizPermitida = sistema.getSistemaArchivos().getDirectorioActual();
            }
        } catch (Exception e) {
            raizPermitida = null;
        }
        ...
        if (raizPermitida != null) {
            try {
                File raizCanonical = raizPermitida.getCanonicalFile();
                fc.setCurrentDirectory(raizCanonical);

                File[] ultimo = new File[1];
    ...
    private void chooseOpen() {
        ...
        try {
            if (sistema != null && sistema.getSistemaArchivos() != null) {
                File dir = sistema.getSistemaArchivos().getDirectorioActual();
