...
public class Reproductor {
    ...
    private void initComponents() {
        ...
        barraProgreso.setForeground(new Color(255, 182, 193));
        ...
        barraProgreso.setUI(new BasicProgressBarUI() {
            ...
            protected void paintDeterminate(Graphics g, JComponent c) {
                ...
                double ratio = (progressBar.getMaximum() > progressBar.getMinimum())
                        ? (progressBar.getValue() - progressBar.getMinimum())
                        / (double) (progressBar.getMaximum() - progressBar.getMinimum())
                        : 0;
        ...
        for (int i = 0; i < nombres.length; i++) {
            ...
            b.setBackground(new Color(255, 20, 147));
